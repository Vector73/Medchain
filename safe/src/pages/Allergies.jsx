              ...
              {allergies.length === 0 ? (
                <Paper sx={{ p: 4, textAlign: "center", borderRadius: 2 }}>
                  ...
                  <Typography
                    ...
                    sx={{ mb: 3 }}
                  >
                    Add your allergies to help healthcare providers give you
                    better care
                  </Typography>
                  <Button
                    variant="contained"
                    ...
                    <TableBody>
                      {allergies.map((record, index) => (
                        ...
                        >
                          ...
                          <TableCell>
                            {formatDate(record.firstOccurrence)}
                          </TableCell>
                          <TableCell>
                            <Button
                              size="small"
        ...
        >
          <SimpleBar style={{ maxHeight: "80vh" }}>
            ...
            <TextField
              ...
              helperText={
                openForm && !formData.allergen ? "This field is required" : ""
              }
            />
            ...
            <TextField
              ...
              helperText={
                openForm && !formData.severity ? "Please select severity" : ""
              }
            >
            ...
            {selectedRecord && (
              <>
                ...
                <Paper variant="outlined" sx={{ p: 2, mb: 2 }}>
                  ...
                  <Typography variant="body1">
                    {formatDate(selectedRecord.firstOccurrence) ||
                      "Not specified"}
                  </Typography>
                </Paper>
