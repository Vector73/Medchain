        ...
        >
          <SimpleBar style={{ maxHeight: "80vh" }}>
            ...
            <TextField
              ...
              helperText={
                openForm && !formData.disease ? "This field is required" : ""
              }
            />
            ...
            <TextField
              ...
              helperText={
                openForm && !formData.time ? "This field is required" : ""
              }
            />
            ...
            <TextField
              ...
              helperText={
                openForm && !formData.solved ? "Please select a status" : ""
              }
            >
            ...
            >
              ...
              <Button
                ...
                onClick={submit}
                disabled={
                  !formData.disease || !formData.time || !formData.solved
                }
              >
                Save
              </Button>
              ...
              <>
                ...
                <Paper variant="outlined" sx={{ p: 2, mb: 2 }}>
                  ...
                  <Typography variant="body1">
                    {formatDate(selectedRecord.time) || "Not specified"}
                  </Typography>
                </Paper>
                  ...
                  {selectedRecord &&
                    medHistory.findIndex(
                      ...
                      <Button
                        variant="contained"
                        onClick={() => {
                          const index = medHistory.findIndex(
                            (r) =>
                              r.disease === selectedRecord.disease &&
                              r.time === selectedRecord.time,
                          );
