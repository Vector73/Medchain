        ...
        >
          <SimpleBar style={{ maxHeight: "80vh" }}>
            ...
            >
              ...
              <MenuItem value="Preventive Screening">
            ...
            <TextField
              ...
              helperText={
                openForm && !formData.date ? "This field is required" : ""
              }
            />
                  ...
                  {selectedRecord &&
                    checkupHistory.findIndex(
                      ...
                      <Button
                        variant="contained"
                        onClick={() => {
                          const index = checkupHistory.findIndex(
                            (r) =>
                              r.checkupType === selectedRecord.checkupType &&
                              r.date === selectedRecord.date,
                          );
