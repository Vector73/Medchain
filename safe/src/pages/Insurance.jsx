...
const InsuranceRecords = () => {
  ...
  const updateBlockchain = async (updatedRecords) => {
    const newHash = await updateBlockchainUtil(
      walletAddress,
      { insuranceRecords: updatedRecords },
      cookies["hash"],
    );
  ...
  const deleteRecord = async (index) => {
    if (
      window.confirm("Are you sure you want to delete this insurance record?")
    ) {
        ...
        >
          <SimpleBar style={{ maxHeight: "80vh" }}>
            ...
            <TextField
              ...
              helperText={
                openForm && !formData.provider ? "This field is required" : ""
              }
            />
            ...
            <TextField
              ...
              helperText={
                openForm && !formData.policyNumber
            ...
            <TextField
              ...
              helperText={
                openForm && !formData.status ? "Please select a status" : ""
              }
            >
              ...
              <>
                ...
                >
                  <Box>
                    ...
                    <Typography variant="body1">
                      {formatCurrency(selectedRecord.coverageAmount)}
                    </Typography>
                  </Box>
                  <Box>
                    <Typography variant="body2" color="textSecondary">
                    ...
                    <Typography variant="body1">
                      {formatCurrency(selectedRecord.premiumAmount)}
                    </Typography>
                  </Box>
                </Paper>
                  ...
                  {selectedRecord &&
                    insuranceRecords.findIndex(
                      ...
                      <Button
                        variant="contained"
                        onClick={() => {
                          const index = insuranceRecords.findIndex(
                            (r) =>
                              r.provider === selectedRecord.provider &&
                              r.policyNumber === selectedRecord.policyNumber,
                          );
